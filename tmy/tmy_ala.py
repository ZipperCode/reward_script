...
SALT = "FR*r!isE5W"
REF_CODE = "WS8QU5"
USER_AGENT = "1.3.4;00000000-646f-9305-0000-000049878777;Xiaomi POCO F2 Pro;Android;13;Release"
...
CHANNEL_IDS = [
    "634cc305fe3fc1680f583163",
    "6328a1effe3fc1537e5646e3",
    "6358dc4ead61a45c31a18ca4",
    "6328a34ead61a4052a4a3319",
]
...
def main():
    print("===============🔔爱临安, 开始!===============\n")
    accounts = get_env_list("TMUYUN_AHA")
    print("============================================")
