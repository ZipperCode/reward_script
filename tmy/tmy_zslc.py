...
cron: * 8 * * *
变量：TMUYUN_ZSLC='session_id=xxx;[invite=0]' 多个账号用 & 分隔 默认助力作者设置invite变量 = 0 或者不设置invite变量后不助力
撸一撸兑换
"""
import base64
import hashlib
...
DEF_VERSION = '2.2.7'
USER_AGENT_PREFIX = ";00000000-646f-9305-ffff-ffffa6b7c59c;Xiaomi POCO F2 Pro;Android;13;Release"

PKG_NAME = "com.zjonline.lucheng"

HEADER2 = {
    "Accept": "application/json, text/plain, */*",
    "User-Agent": 'Mozilla/5.0 (Linux; Android 13; POCO F2 Pro Build/TQ3A.230705.001; wv) AppleWebKit/537.36 (KHTML, '
                  'like Gecko) Version/4.0 Chrome/115.0.5790.136 Mobile '
                  f'Safari/537.36;xsb_lucheng;xsb_lucheng;{DEF_VERSION};native_app',
    'X-Requested-With': PKG_NAME,
...
CHANNEL_IDS = [
    "5d5361fb1b011b137b853d34", "5d536248b19850248f2cd1a0", "5d53646ab19850248f2cd1a5", "5d5363831b011b137b853d37",
    "5d5362deb19850248f2cd1a1", "5da4082d1b011b7c692ffdf9"
]
...
class TmuYun:
    ...
    def init_app(self):
        ...
        headers = {
            ...
            'User-Agent': f'ANDROID;13;10008;{DEF_VERSION};1.0;null;POCO F2 Pro',
    ...
    def forum_list(self):
        ...
        dict.update(headers, {
            'User-Agent': 'Mozilla/5.0 (Linux; Android 13; POCO F2 Pro Build/TQ3A.230705.001; wv) AppleWebKit/537.36 '
                          ...
                          f'Safari/537.36;xsb_shangyu;xsb_shangyu;{DEF_VERSION};native_app;',
            'Sec-Fetch-Site': 'same-origin',
            'Sec-Fetch-Mode': 'cors',
            'Sec-Fetch-Dest': 'empty',
            'Accept': '*/*',
...
def main():
    app = "掌上鹿城"
    print(f"===============🔔{app}, 开始!===============\n")
    accounts = get_env_list("TMUYUN_ZSLC")
    print("============================================")
